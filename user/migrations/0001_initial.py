# Generated by Django 5.1.3 on 2025-04-01 07:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('administrator', 'Administrator'), ('moderator', 'Moderator'), ('user1', 'User1'), ('user2', 'User2'), ('user3', 'User3')], db_index=True, default='user3', max_length=20, verbose_name='User Role')),
                ('user_status', models.CharField(choices=[('block', 'Bloklash'), ('active', 'Aktivlashtirish'), ('waiting', 'Kutib turing')], db_index=True, default='waiting', max_length=10, verbose_name='Foydalanuvchi Holati')),
